          ...
          <div className="mt-[3rem]">
            <div className="md:grid  gap-x-[1rem] grid-cols-2 ">
              <div className="md:my-0 my-[1rem]">
                <TextField
                  label="The founder / HR personnel’s  name"
                  ...
                  errMsg={
                    errMsgs.director_name &&
                    capitalizeFirstLetter(errMsgs.director_name)
                  }
              ...
              <div className="md:my-0 my-[1rem]">
                <TextField
                  label="The HR personnel's / founder’s phone number"
                  fontSize="text-[0.75rem] font-[600] w-full"
                  type="text"
                  paddingY="py-[0.6rem]"
                  ...
                  onChange={handleOnChange}
                  errMsg={
                    errMsgs.director_phone_number &&
                    capitalizeFirstLetter(errMsgs.director_phone_number)
                  }
                  // value="General Manager"
                  // errMsg="hjkkj"
                />
            ...
            <div className="md:grid gap-x-[1rem] grid-cols-2 md:my-[2rem]">
              <div className="md:my-0 my-[1rem]  relative">
                <TextField
                  ...
                  onChange={handleOnChange}
                  errMsg={
                    errMsgs.lowest_paid_salary &&
                    capitalizeFirstLetter(errMsgs.lowest_paid_salary)
                  }
                  // defaultValue={ data.lowest_paid_salary}
                  // errMsg="hjkkj"
                />
                <p className="absolute right-[10%] top-[53%] text-[0.8rem]">
                  per month
                </p>
              </div>
              ...
              <div className="relative">
                <TextField
                  ...
                  onChange={handleOnChange}
                  errMsg={
                    errMsgs.highest_paid_salary &&
                    capitalizeFirstLetter(errMsgs.highest_paid_salary)
                  }
                  // defaultValue={data.highest_paid_salary}
                  // errMsg="hjkkj"
                />
            ...
            <div className="flex justify-center items-center">
              <button
                ...
                className="text-[#374151] flex items-center"
              >
                <span className="">
                  <MdArrowBackIos />
                </span>{" "}
