...
import { useAllOrgPayroll, usePayrollOverview } from '../../services/admin/queries'
...
let {error:errorMsg, data:res,mutate, isSuccess } = useGeneratePayroll()
  ...
  let {data, isLoading,error,isError, refetch} = useAllOrgPayroll(monthYear)
    ...
    <AdminCustomLayout>
       <Modals  isOpens={isModalOpen} setIsopens={setIsModalOpen} title="Payroll action">
        ...
        <ComponentLeft>
            ...
            text={<>Upcoming salary payment <br />in 4 days time </>}
