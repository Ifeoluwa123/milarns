...
<div className=' max-w-[46rem] w-[100%] md:py-[2rem] md:pl-[3rem]'>
      ...
      <div className="bg-[#F5F5F5]   px-[1rem] py-[2rem] rounded-[4px]">
        ...
        <div className="flex justify-between items-center">
            <p className='font-[600] text-[0.85rem]'>Select staffs you want to pay deduction to</p>
        ...
        <PayrollDataTableAction buttonText= "Proceed to record deduction" setIsOpen={setIsOpen} data={data} type="type-2" itemsPerPage={6} />
