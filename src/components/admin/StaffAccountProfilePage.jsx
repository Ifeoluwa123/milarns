...
export default function StaffAccountProfilePage({ data }) {
  ...
  let init = {
    ...
    on_create_accept_terms_and_condition:
      data && data.on_create_accept_terms_and_condition,
    // bank_first_name:'',
    // bank_last_name:'',
    // account_number:'',
    // bank_code:'',
  ...
  queryClient.invalidateQueries({
    queryKey: ["getSingleDetailsEmployeeData" + staffId],
  });
  ...
  const handleSubmit = (e) => {
    ...
    mutate(
      { staffCode: staffId, data: employeeData },
      {
  ...
  return (
      ...
      {!data ? (
        ...
        <div className="">
          ...
          <div className="">
            ...
            <ChangeUserImage
              userImage={employeeData.avatar ? employeeData.avatar : userImage}
    ...
    />*/}
        ...
        We confirm that this person is a staff at Williams Specialist Hospital located at No 14 Roadrid street, Ikeja Lgos, Nigeria and he’s oblige to  be taking salary in-advance through WagePull Inc.
                ...
                {!isSuccess ? null : (
                  <p className="py-[1rem] text-[var(--primary-color)]">
              ...
              <div className=" mt-[3rem]">
                <div className="flex items-start flex-wrap gap-x-[1rem] sm:flex-nowrap gap-y-[1.5rem]">
                  <InnerButton
                    ...
                    text={`${isPending ? "Loading..." : "Update profile"}`}
                    type="button"
                    width="w-fit "
                  />
                  <OutlineButton
