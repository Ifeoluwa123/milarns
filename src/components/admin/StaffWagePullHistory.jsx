...
import { useGetSingleEmployeeWagepullHistory } from '../../services/admin/queries'
...
export default function StaffWagePullHistory() {
    ...
    let {data, isLoading, isError, error} = useGetSingleEmployeeWagepullHistory(staffId)
    if(isLoading) {
        ...
        <div className='data_table   no-scrollbar mb-[14rem]   overflow-x-auto scrollbar-hidden-x'>
         ...
         <thead   >
                 <tr  >
                     ...
                     <th className=' md:table-cell z-[20]'>Name</th>
                     <th className=' md:table-cell z-[20]'>Amount</th>
                     <th className='hidden md:table-cell z-[20]'>Bank name</th>
                     <th className='hidden md:table-cell z-[20]'>Account number</th>
                     <th className='hidden md:table-cell z-[20]'>Account name</th>
    ...
    
{
  ...
  <td  className='hidden md:table-cell'>{item.bank_name}</td>
  <td  className='hidden md:table-cell'>{item.account_number}</td>
  <td  className='hidden md:table-cell'>{item.account_name}</td>
  <td  className='hidden md:table-cell'>{formatDate2(item.created_at) }</td>
  <td  className='hidden md:table-cell '><p className="flex items-center font-[600]"><span className='text-[1.3rem]'><TbCurrencyNaira /></span>{item.fee}</p></td>
...
<p className='flex items-center font-[600]'>
    <span className='text-[1.3rem]'><TbCurrencyNaira /></span>
    {/* {item.amount_received} */}
    {item?.amount_received? item?.amount_received : 0}
    .00
  ...
  }
  {
    ...
    <td colSpan="4"  className='pt-[2rem] px-[2rem] md:hidden'>
            ...
            <h5 className='flex-[0_0_50%] font-[580] text-[#6B7280]'>Bank name:</h5>
            <p className='flex-[0_0_50%] font-[600]'>{selectedUser.bank_name}</p>
            <h5 className='flex-[0_0_50%] font-[580] text-[#6B7280]'>Account number:</h5>
            <p className='flex-[0_0_50%] font-[600]'>{selectedUser.account_number}</p>
            <h5 className='flex-[0_0_50%] font-[580] text-[#6B7280]'>Account name:</h5>
            <p className='flex-[0_0_50%] font-[600]'>{selectedUser.account_name}</p>
            ...
            <h5 className='flex-[0_0_50%] font-[580] text-[#6B7280]'>Fee:</h5>
