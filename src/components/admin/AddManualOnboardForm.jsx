            ...
            <div className="">
              <form onSubmit={handleSubmit} className="mt-[2rem]  pb-[3rem]">
                <div
                  ...
                  htmlFor="profilePic"
                  className={`mb-[2rem] flex flex-col hover:cursor-pointer justify-center items-center ${
                    previewImage.profileImage
                      ? "max-w-[150px] border-none w-full overflow-hidden"
                      : "bg-[var(--grey-color)]   w-[110px]   md:w-[160px]  "
                  } h-[110px] md:h-[160px] border-2 border-dashed border-[#6B7280]  rounded-[5px]`}
                >
                  <input
                    type="file"
                    onChange={(e) => handlePreviewImage(e.target)}
                    id="profilePic"
                    className="hidden"
                  />
                  {previewImage.profileImage ? (
               ...
               } 
            {
                ...
                <div className=" md:grid md:grid-cols-2 lg:grid-cols-3 gap-y-[1rem] md:flex-row items-center w-full md:gap-x-[2rem]">
                  ...
                  <div className="flex flex-col mb-[2rem] justify-center md:mb-[0.4rem]">
                    <label htmlFor="state" className=" text-[0.875rem] ">
                      State
                    </label>
                    <select
                      onChange={handleOnChange}
                      ...
                      name="state"
                      className="focus:input-border outline-none border-[0.9px] mt-[0.5rem] text-[0.85rem] px-[0.6rem]  py-[0.7rem] w-full  transition-[border] duration-[0.4s] rounded-[6px] "
                    >
                  ...
                  <div className="flex flex-col mb-[2rem] justify-center md:mb-[0.4rem]">
                    <label htmlFor="country" className=" text-[0.875rem] ">
                      Country
                    </label>
                    <select
                      onChange={handleOnChange}
                  ...
                  <div className=" w-full mb-[3rem] md:mb-0">
                    <SelectField
                      ...
                      onChange={handleOnChange}
                      errMsg={
                        errMsgs.mode_of_identification &&
                        errMsgs.mode_of_identification
                      }
                    />
                  </div>
                  ...
                  <div className=" w-full mb-[2rem] md:mb-0">
                    <TextField
                      ...
                      onChange={handleOnChange}
                      errMsg={
                        errMsgs.mode_of_identification_number &&
                        errMsgs.mode_of_identification_number
                      }
                    />
                  </div>
                ...
                <div className="mt-[3rem]">
                  <h1 className="font-[600] text-[1rem]">
                    Provide staff bank details
                  </h1>
                  ...
                  <div className=" mt-[1.5rem] md:grid md:grid-cols-2 lg:grid-cols-3 gap-y-[1rem] md:flex-row items-center w-full md:gap-x-[2rem]">
                    <div className=" w-full mb-[2rem] md:mb-0">
                      <TextField
                        ...
                        onChange={handleOnChange}
                        errMsg={
                          errMsgs.bank_first_name && errMsgs.bank_first_name
                        }
                      />
                    </div>
                    ...
                    <div className=" w-full mb-[2rem] md:mb-0">
                      <TextField
                        ...
                        onChange={handleOnChange}
                        errMsg={
                          errMsgs.bank_last_name && errMsgs.bank_last_name
                        }
                      />
                    </div>

                    <div className="flex flex-col mb-[2rem] justify-center md:mb-[0.4rem]">
                      <label htmlFor="bank_name" className=" text-[0.875rem] ">
                        Bank name
                      </label>
                      <select
                        onChange={handleOnChange}
                    ...
                    <div className=" w-full mb-[2rem] md:mb-0">
                      <TextField
                        ...
                        onChange={handleOnChange}
                        errMsg={
                          errMsgs.account_number && errMsgs.account_number
                        }
                      />
                    </div>
                ...
                <div className="mt-[3rem]">
                  ...
                  <div className="md:flex gap-x-[2rem] md:items-center mt-[1rem] w-full">
                    ...
                    <div className=" w-auto mb-[2rem] md:mb-[-1.3rem]">
                      <TextField
                        ...
                        onChange={handleOnChange}
                        errMsg={
                          errMsgs.work_hour_per_day && errMsgs.work_hour_per_day
                        }
                      />
                    </div>
                  ...
                  <div className=" w-full mt-[1rem] md:mb-0">
                    ...
                    <CheckboxWithLabel
                      ...
                      checked={employeeData.sunday}
                      name="sunday"
                      label="Sunday"
                    />
                    <CheckboxWithLabel
                      onChange={handleCheckboxChange}
                      checked={employeeData.monday}
                      name="monday"
                      label="Monday"
                    />
                    <CheckboxWithLabel
                      onChange={handleCheckboxChange}
                      checked={employeeData.tuesday}
                      name="tuesday"
                      label="Tuesday"
                    />
                    <CheckboxWithLabel
                      onChange={handleCheckboxChange}
                      checked={employeeData.wednesday}
                      name="wednesday"
                      label="Wednesday"
                    />
                    <CheckboxWithLabel
                      onChange={handleCheckboxChange}
                      checked={employeeData.thursday}
                      name="thursday"
                      label="Thursday"
                    />
                    <CheckboxWithLabel
                      onChange={handleCheckboxChange}
                      checked={employeeData.friday}
                      name="friday"
                      label="Friday"
                    />
                    <CheckboxWithLabel
                      onChange={handleCheckboxChange}
                      checked={employeeData.saturday}
                      name="saturday"
                      label="Saturday"
                    />
                  </div>
                ...
                <div className="mt-[3rem]">
                  ...
                  <div className="flex items-center my-[1.5rem] gap-x-[0.5rem]">
                    <Checkbox
                      name="on_create_accept_terms_and_condition"
                      checked={
                        employeeData.on_create_accept_terms_and_condition
                      }
                      onChange={(e) =>
                  ...
                  <p className="text-[var(--secondary-color)] font-[500]">
                    You need to confirm this staff to proceed
                  </p>
                  ...
                  {error && (
                    <div
                      className={`${
                        errMsgs.error &&
                        "bg-[#FDEAEA] mt-[1rem]  text-[#FE5E55] mb-[1rem] rounded-[4px] w-fit p-[4px_20px_4px_20px]"
                      }`}
                    >
                      {errMsgs.error}
                    </div>
                ...
                <div className=" mt-[3rem]">
                  <div className="flex items-start flex-wrap gap-x-[1rem] sm:flex-nowrap gap-y-[1.5rem]">
                    <Button
                      bgColor={`${
                        !employeeData.on_create_accept_terms_and_condition
                          ? "bg-grey-500 text-black cursor-not-allowed"
                    ...
                    {/* <button
                type="button"
                className="p-[14px_28px_14px_28px] hover:bg-[var(--grey-color)]  hover:border-none transition-all duration-[0.3s]  border-[1px] border-[#374151] rounded-[4px]"
              >
                Save
              </button> */}
                  </div>
