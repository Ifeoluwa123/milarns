  ...
  return (
    <div className="mt-[2rem]">
      <p className="text-[0.85rem] mb-[1rem]">
        ...
        <Link
          to="#"
          className="text-[var(--secondary-color)] font-[600] leading-[24px]"
        >
          Staff Bulk Onboard Template
        </Link>{" "}
        you can follow to onboard staff data.
      </p>

      <div className="mt-[1rem]">
        <div
          onClick={() => document.getElementById("excelFile").click()}
          className={`flex flex-col hover:cursor-pointer justify-center items-center ${
            selectedFile
              ? " w-full overflow-hidden"
              : "border-2 border-dashed w-full    md:w-full  "
          } md:max-w-[1111px] h-[180px]  border-[#6B7280] bg-[var(--grey-color)]   rounded-[5px]`}
        >
          <input
            type="file"
        ...
        <div className="mt-[3rem]">
          ...
          <div className="flex items-center my-[1.5rem] gap-x-[0.5rem]">
            ...
            <p className="text-[0.85rem] leading-[24px]">
              We confirm that this person is a staff at Williams Specialist
              Hospital located at No 14 Roadrid street, Ikeja Lgos, Nigeria and
              he’s oblige to be taking salary in-advance through WagePull Inc.
            </p>
          </div>
        ...
        <div className=" mt-[3rem]">
          <div className="flex items-start flex-wrap gap-x-[1rem] sm:flex-nowrap gap-y-[1.5rem]">
            <Button
              ...
              text={`${isPending ? "Loading..." : "Onboard new staffs"}`}
              onClick={handleUpload}
              type="button"
              width="w-fit "
              padding="px-[2rem] py-[1rem]"
            />
