    ...
    <div className="pb-[6rem]">
      ...
      <form encType="multipart/form-data" onSubmit={handleSubmit}>
        <div className="grid md:grid-cols-[340px_340px] gap-x-[5rem] gap-y-[1rem]">
          ...
          />
          <TextField
            label="HR Personnel’s phone Number"
            value={userData.director_phone_number}
        ...
        <div className="mt-[2rem] relative">
          ...
          <input
            ...
            className="logo invisible absolute"
          />
          ...
          <div
            ...
            className={`rounded-[4px] hover:cursor-pointer  ${
              userData.logo != ""
                ? ""
                : "  justify-center h-[180px]  items-center"
            } mt-[0.4rem] text-[#6B7280] flex   flex-col max-w-[160px] w-full  border-2`}
          >
            {userData.logo != "" ? (
              <div className="flex ">
