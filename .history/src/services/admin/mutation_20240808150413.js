...
export function useDeleteEmployee(){
    ...
    const queryClient = useQueryClient();
    return useMutation({
        mutationKey:['deleteEmployeeData'],
...
export function useActivateSingleEmployeeData (){

    const queryClient = useQueryClient();
    return useMutation({
        mutationKey:['activateSingleEmployeeData'],
        mutationFn:(staffCode)=>activateSingleEmployeeData(staffCode),
...
// To Deativate Staff 
export function useDeactivateSingleEmployeeData(){

    const queryClient = useQueryClient();
    return useMutation({
        mutationKey:['deactivateSingleEmployeeData'],
        mutationFn:(staffCode)=>deactivateSingleEmployeeData(staffCode),
