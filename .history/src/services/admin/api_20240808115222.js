...
// {{baseUrl}}/organization/{{organization_code}}/staff/bulk/activate/
...
export const activateSingleEmployeeData = async (staffCode)=>{
    ...
    const response = await axiosInstance.patch('organization/'+adminInfo.organization.code+'/staff/bulk/activate', staffCode,accessToken)
...
//    console.log({codes:[staffCode]})
    ...
    const response = await axiosInstance.patch('organization/'+adminInfo.organization.code+'/staff/bulk/deactivate/',{codes:[staffCode]} ,accessToken)
