...
export const requestCard = async (staffCode)=>{
    ...
    const response = await axiosInstance.post('/cards/organization/'+adminInfo.organization.code+'/staff/'+staffCode+'/request/', accessToken)
    return response.data
}

// {{baseUrl}}/cards/organization/{{organization_code}}/staff/{{staff_code}}/
