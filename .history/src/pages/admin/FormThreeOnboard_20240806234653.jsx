...
if(isSuccess){
  ...
  return (
    <div className='bg-white  mt-[1rem] rounded-[4px] px-[1rem] md:px-[2rem] py-[2rem] max-w-[570px] w-full'>
        ...
        <div className="">
        <span className={` ${errMsgs?.bank_code? 'visible input-field-error-message':'invisible' }   mt-[0.1rem] ml-[0.2rem] text-[0.8rem] `}>{errMsgs?.bank_code && "Bank name is required"}</span>
        </div>
