      ...
      <div className="bg-[#F5F5F5]   px-[1rem] py-[2rem] rounded-[4px]">
        ...
        <thead   >
         ...
         <div className="mt-[2rem]  flex items-center justify-between sm:max-w-[60%] gap-x-[1rem]">
                    ...
                    <Button  disabled={!selectUsers.length > 0}  bgColor={!selectUsers.length > 0? "bg-grey-500 text-black cursor-not-allowed" : "bg-[var(--secondary-color)] text-white" }  text={"Proceed to make payment"} padding="py-[0.6rem]" />
