      ...
      <div className="bg-[#F5F5F5]   px-[2rem] py-[2rem] rounded-[4px]">
        ...
        <div className="mt-[2rem]">
         ...
         <div className="mt-[2rem]  flex items-center justify-between sm:max-w-[60%] gap-x-[1rem]">
                    ...
                    <Button  bgColor={true? "bg-grey-500 text-black cursor-not-allowed" : "bg-[var(--secondary-color)] text-white" }  text={isPending? "Loading...": "Record bonus now"} padding="py-[0.6rem]" />
