...
export default function AdminDashboard() {
  ...
  return (
    ...
    <div className='border- border-red-600  h-auto mb-[4rem] '>
   ...
   <AdminCustomLayout>
    {/* DashBoard */}
        ...
        isRecentWageloading? <h1 className='flex h-full justify-center items-center h-[50vh] p-[1rem] border-[1px] rounded-[4px] my-[2rem] overflow-hidden'>Loading</h1> : 
