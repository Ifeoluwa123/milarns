      ...
      <div className="bg-[#F5F5F5]   px-[2rem] py-[2rem] rounded-[4px]">
        ...
        <div className="mt-[2rem]">
         ...
         <div className="mt-[2rem]  flex items-center justify-between sm:max-w-[60%] gap-x-[1rem]">
                    ...
                    <Button onClick={handleSubmit}  bgColor={!selectUsers.length > 0? "bg-grey-500 text-black cursor-not-allowed" : "bg-[var(--secondary-color)] text-white" }  text={"Proceed to make payment"} padding="py-[0.6rem]" />
