  ...
  return (
    <div className='bg-white  mt-[1rem] rounded-[4px] px-[1rem] md:px-[2rem] py-[2rem] max-w-[570px] w-full'>
        <div className="flex justify-between items-center text-[0.9rem]">
            <h1 className='font-[600]'>Organisation Salary account</h1>
        ...
        <select defaultValue = {data.bank_code} onChange={(e)=>setData({...data, bank_code:e.target.value})}   id='bank_code'  name="bank_code"  className="focus:input-border outline-none border-[0.9px] mt-[0.5rem] text-[0.85rem] px-[0.6rem]  py-[0.7rem] w-full  transition-[border] duration-[0.4s] rounded-[6px] ">
            ...
            { 
                ...
                {/* <TextField 
                 ...
                 <TextField 
                        ...
                        onChange={handleOnChange}
                        // errMsg={errMsg?.response.data.errors.account_name && errMsg.response.data.errors.account_name}
                        errMsg={errMsgs.account_name && capitalizeFirstLetter(errMsgs.account_name)}
                        // value="General Manager"
                        // errMsg="hjkkj"
          ...
          <div className="flex justify-center items-center">
              <button type="button" onClick={()=>navigate('/onboarding_2')} className='text-[#374151] flex items-center'><span className=""><MdArrowBackIos /></span> Previous Step</button>
          </div>
