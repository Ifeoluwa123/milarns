    ...
    <div className=' max-w-[46rem] w-[100%] md:py-[2rem] md:pl-[3rem] '>
      ...
      <div className="bg-[#F5F5F5]   px-[2rem] py-[2rem] rounded-[4px]">
        ...
        <div className="flex justify-between items-center">
            ...
            <InnerButton onClick={()=>handleSelectAll(selectAll, setSelectAll, unpaidStaff, setData,  setSelectedUsers)} text="Select all staffs" width='w-fit text-[0.85rem]' />
        </div>
             ...
             <tbody className='bg-white '>
             {
                paginatedData.map((item,i)=>{
                 ...
                 <tr    className='relative z-[10]  hover:bg-[--grey-color] rounded-md hover:shadow-[0px_2px_1px_0px_rgba(0,0,0,1)] '>
                        ...
                        <td ><Checkbox  name={item.staff.code} checked={item.staff.checked}  onChange={(e)=>handleRowChange(item.staff.code, data, setData, setSelectAll, setSelectedUsers)}  /></td>   
                 </tr>
