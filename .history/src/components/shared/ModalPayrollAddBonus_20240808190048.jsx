...
useEffect(function(){
  ...
  <div className="py-[1rem] px-[1rem] bg-[#F5F5F5] text-black rounded-[4px] ">
    ...
    <div className="">
      <InnerButton onClick={handleAddBonus} disabled={ payload.amount.length == 0 && payload.medium.length == 0 } text={isPending? "Loading...": "Record bonus now"} width="flex justify-center w-full" />
