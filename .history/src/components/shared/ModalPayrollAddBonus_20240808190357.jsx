...
useEffect(function(){
  ...
  <div className="py-[1rem] px-[1rem] bg-[#F5F5F5] text-black rounded-[4px] ">
    ...
    <div className="">
      ...
      <Button onClick={handlepayout} disabled={value.amount_left > 0 } bgColor={value.amount_left > 0 ? "bg-grey-500 text-black cursor-not-allowed" : "bg-[var(--secondary-color)] text-white" }  text={isPending? "Loading...": "Record bonus now"} padding="py-[0.6rem]" />
    </div>
