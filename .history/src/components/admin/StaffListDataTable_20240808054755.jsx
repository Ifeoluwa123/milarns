...
<p>{selectedUser.email}</p> */}
     ...
     <div className="px-[0.8rem] relative sm:px-[3rem] lg:px-[2rem]   flex  flex-col gap-y-[1rem] sm:flex-row sm:items-center sm:justify-between border-2 mt-[0rem] pr-[1.8rem] " >
