                 ...
                 <tr    className='relative z-[10]  hover:bg-[--grey-color] rounded-md hover:shadow-[2px_2px_1px_2px_rgba(0,0,0,1)] '>
                         ...
                         <td className=''>
                          ...
                          <td className='relative ' >
                              ...
                              <span onMouseOut={() => handleRowClick(null)} onMouseOver={() => handleRowClick(item.code)} className='table_row hidden md:block cursor-pointer '><BiDotsVerticalRounded /></span>
