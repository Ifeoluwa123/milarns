        ...
        <div className="mt-[3rem]">
                            ...
                            <div className=" mt-[3rem]">
                                <div className="flex items-start flex-wrap gap-x-[1rem] sm:flex-nowrap gap-y-[1.5rem]">
                                    <Button bgColor={`${!checkBox ? 'bg-grey-500 text-black cursor-not-allowed' : 'bg-[var(--secondary-color)] text-white'}`} text={`${isPending? "Loading...": "Onboard new staffs"}`} onClick={handleUpload}  type="button" width="w-fit " padding="px-[2rem] py-[1rem]" />
