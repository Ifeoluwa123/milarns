         ...
         <div className="md:mr-[1rem] lg:mr-[3rem]">
            ...
            <div  className="header_menu w-full h-full cursor-pointer flex items-center gap-[0.5rem] ml-[0.8rem] md:ml-[2rem]">
                        ...
                        <div className=' relative'>
                            ...
                            <ul className=' absolute top-[100%] mt-[1.1rem] right-[-100%]  md:text-black    md:right-[-5%]  bg-[var(--grey-color)] w-[300px] max-w-[150px] mr-[1rem] md:mr-[0rem] shadow-[2px_2px_1px_1px_rgba(0,0,0,1)] rounded-sm '>
