         ...
         <div className="flex  items-center w-full gap-x-[1rem]  sm:gap-x-[1rem]  sm:flex-row">
             <div className="rlative">
               ...
               <TableMenuList  items={[
                  ...
                  {icon:<LiaUserAltSlashSolid size={15} />, onClick:()=>handleBulkSelection('Dactivate', <LiaUserAltSlashSolid size={18} />), text: "Deactivate staffs", type:"", actionType:"deactivate"},      
