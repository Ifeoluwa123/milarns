         ...
         <div className="md:mr-[1rem] lg:mr-[3rem]">
            ...
            <div onClick={()=>setIsLoginBar(prev=>!prev)} className=" cursor-pointer flex items-center gap-[0.5rem] ml-[0.8rem] md:ml-[2rem]">
                        ...
                        <div className='   '>
                            ...
                            <div className={`   absolute top-[100%] right-[-2%]  md:right-[-5%] lg bg-[var(--grey-color)] w-[300px] max-w-[150px] mr-[1rem] md:mr-[5rem] shadow-[2px_2px_1px_1px_rgba(0,0,0,1)] rounded-sm `}>
