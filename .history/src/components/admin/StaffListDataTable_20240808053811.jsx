...
{selectedUser?.code === item.code && (
                    ...
                    <>
                        {/* DESKTOP VIEW */}
                       <div className="bg-[var(--grey-color)] absolute  md:right-[2%]   hover:bg-[var(--grey-color)] z-[200]">
                           <div className="  border-2  mt-[-15px] hidden md:block   p-0 z-[50]   rounded-md overflow-hidden  bg-[var(--grey-color)]  w-fit  shadow-[2px_2px_1px_2px_rgba(0,0,0,1)]">
                          ...
                          {/* MOBILE VIEW */}
                          <div  className='pt-[2rem] px-[2rem] md:hidden'>
