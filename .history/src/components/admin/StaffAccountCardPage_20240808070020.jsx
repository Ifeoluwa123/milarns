...
<p className='mt-[33px] p-[4px_20px_4px_20px] max-w-[408px] w-fit rounded-[4px] bg-[#F3F4F6] text-[#008080]'>Staff credit card has been requested, it will be delivered as soon as possible</p>
