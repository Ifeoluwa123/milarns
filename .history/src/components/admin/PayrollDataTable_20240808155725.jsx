...
export default function PayRollDataTable({data,setData,handleDateChange, monthYear,itemsPerPage,addNewstaffHandler }) {
     ...
     <div className='data_table   no-scrollbar    overflow-x-auto scrollbar-hidden-x'>
              ...
              <thead   >
                 <tr  >
                     ...
                     <th className='z-[20] ml-[2rem]  md:ml-[2rem] '>Name</th>
             ...
             <tbody>
                ...
                paginatedData.map((item,i)=>{
                 ...
                 <tr    className='relative z-[10]  hover:bg-[--grey-color] rounded-md hover:shadow-[2px_2px_1px_2px_rgba(0,0,0,1)] '>
                         ...
                         <td className='flex ml-[1rem] pl-0 md:ml-[2rem] items-center gap-x-0 md:gap-x-[1rem] sm:min-w-[200px] min-w-fit'>
...
{selectedUser?.code === item.code && (
  ...
  <tr  className='bg-[var(--grey-color)]   hover:bg-[var(--grey-color)]   '>
    ...
    <td colSpan="4"  className='pt-[2rem] px-[2rem] md:hidden'>
     ...
     <div className=" relative sm:px-[1rem]    flex  flex-col gap-y-[1rem] sm:flex-row sm:items-center sm:justify-between mt-[2rem] pr-[1.8rem] " >
