    ...
    <div>
         <h1 className='bg-[var(--primary-color)] text-white rounded-full text-center py-[0.6rem] md:py-[0.8rem]  '>Testimonial from user</h1>
                                  ...
                                  <div className=" right-bar-bg rounded-[5px] px-[1rem] pb-[0.4rem]">
                                        ...
                                        <p className='relative top-[2.5rem] font-[600]   w-[600] text-[1rem] text-black'>“Our favorite thing about WagePull is the ability for employee to easily get their salary in advance and also pay salary in one-go.”</p>
