         ...
         <div className="md:mr-[1rem] lg:mr-[3rem]">
            ...
            <div  className="header_menu cursor-pointer flex items-center gap-[0.5rem] ml-[0.8rem] md:ml-[2rem]">
                        ...
                        <div className='header_menu'>
                            ...
                            <div className={` header_link_items  relative  right-[-2%]  md:right-[-5%] lg bg-[var(--grey-color)] w-[300px] max-w-[150px] mr-[1rem] md:mr-[5rem] shadow-[2px_2px_1px_1px_rgba(0,0,0,1)] rounded-sm `}>
