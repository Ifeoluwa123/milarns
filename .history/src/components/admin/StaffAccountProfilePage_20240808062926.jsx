...
<div className=" md:grid md:grid-cols-2 lg:grid-cols-3 gap-y-[1rem] md:flex-row items-center w-full md:gap-x-[2rem]">
    ...
    <div className=" w-full mb-[3rem] md:mb-0">
                                    ...
                                    <select   onChange={handleOnChange} defaultValue={employeeData.state}  name="state"  className="focus:input-border outline-none border-[0.9px] mt-[0.5rem] text-[0.85rem] px-[0.6rem]  py-[0.7rem] w-full  transition-[border] duration-[0.4s] rounded-[6px] ">
