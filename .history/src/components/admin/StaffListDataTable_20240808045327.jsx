...
// };
//selectAll, setSelectAll, data:staffList.results, setData, setSelectAll, setSelectedUsers
...
// staffCode, data, setData, setSelectAll, setSelectedUsers
    ...
    return (
     ...
     <div className='data_table   no-scrollbar    overflow-x-auto scrollbar-hidden-x'>
              ...
              <thead   >
                 <tr  >
                     <th className='z-[20]'><Checkbox checked={selectAll} name="selectAll" onChange={()=>handleSelectAll(selectAll, setSelectAll, staffList.results, setData, setSelectAll, setSelectedUsers)}  /></th>
             ...
             <tbody>
                ...
                paginatedData.map((item,i)=>{
                 ...
                 <tr    className='relative z-[10]  hover:bg-[--grey-color] rounded-md hover:shadow-[2px_2px_1px_2px_rgba(0,0,0,1)] '>
                         ...
                         <td ><Checkbox    name={item.code} checked={item.checked} onChange={(e)=>handleRowChange(item.code)}   /></td>
