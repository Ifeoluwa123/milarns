  ...
  return (
    ...
    >
      <ModalContent className='bg-white  rounded-md'>
        {(onClose) => (
          <>
            <ModalHeader className="bg-[linear-gradient(to_bottom,rgb(254,94,85),rgb(254,94,85))] z-[-1] text-white border-none flex justify-between items-center  gap-1 outline-none">
                OTP Code

                 <span className="cursor-pointer bg-[url('../assets/images/bg-modal-header.png')] block w-full" onClick={()=>setIsopens(false)}><AiOutlineClose size={20} /></span>
                 </ModalHeader>
