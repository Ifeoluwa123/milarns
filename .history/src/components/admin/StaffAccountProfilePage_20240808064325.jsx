...
import { useBankNames, useCountryLists, useNigeriaState, useSingleEmployeeData } from '../../services/admin/queries'
...
export default function StaffAccountProfilePage() {
    ...
    const {data, isLoading, isError, error} = useSingleEmployeeData(staffId)
    // {
    //     avatar:data.avatar, 
