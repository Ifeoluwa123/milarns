...
const handleSelectAll = () => {
  ...
  setSelectedUsers(newRows.filter(item=>item.checked && item.code))
...
const handleRowChange = (staffCode) => {
  ...
  setSelectedUsers(newRows.filter(item=>item.checked == true &&  item.code))
};
...
console.log(selectedUsers)
    ...
    return (
     ...
     <div className='data_table   no-scrollbar    overflow-x-auto scrollbar-hidden-x'>
              ...
              <thead   >
                 <tr  >
                     <th className='z-[20]'><Checkbox checked={selectAll} name="selectAll" onChange={handleSelectAll}  /></th>
