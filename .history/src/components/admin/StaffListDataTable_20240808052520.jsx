                 ...
                 <tr    className='relative z-[10]  hover:bg-[--grey-color] rounded-md hover:shadow-[2px_2px_1px_2px_rgba(0,0,0,1)] '>
                         ...
                         <td className=''>
                          ...
                          <td className='relative ' >
                              ...
                              <span onClick={() => handleRowClick(item.code)} className='cursor-pointer relative'><BiDotsVerticalRounded /></span>
...
{selectedUser?.code === item.code && (
      ...
      <div className="border-2 h-[200px] w-[200px] bg-red-400 absolute top-[0] z-[200]">
