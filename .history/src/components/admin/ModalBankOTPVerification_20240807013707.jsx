        ...
        {(onClose) => (
          <>
            ...
            <p className='text-gray-500 text-[1rem] md:text-[0.88rem] leading-8 '>Please input  the 6 digit character sent to ---</p>
                ...
                <TextField label="OTP Code" onChange={(e)=>setOtpCode(e.target.value)} type="text" paddingY='py-[0.4rem] mt-[0]' placeholder="Enter the OTP Code"/>
                <Button text={isPending? 'Loading...' : 'Submit'} type="submit" padding="py-[0.4rem]" />
