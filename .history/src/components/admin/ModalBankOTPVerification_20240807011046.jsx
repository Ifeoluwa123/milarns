  ...
  return (
    ...
    >
      <ModalContent className='bg-white  rounded-md'>
        {(onClose) => (
          <>
            <ModalHeader className="bg-[#FE5E55] text-white border-none flex justify-between items-center  gap-1 outline-none">
                OTP Code
            ...
            <p className='text-gray-500 text-[1rem] md:text-[0.88rem] leading-8 '>Please input  the 6 digit character sent to olu************.com</p>
            </div>

                <TextField placeholder="Enter the OTP Code"/>
