...
<div className=" md:grid md:grid-cols-2 lg:grid-cols-3 gap-y-[1rem] md:flex-row items-center w-full md:gap-x-[2rem]">
    ...
    />
        ...
        We confirm that this person is a staff at {adminInfo.organization.name} located at  {adminInfo.organization.address}, Nigeria and he’s oblige to  be taking salary in-advance through WagePull Inc.
        </p>
    </div>
