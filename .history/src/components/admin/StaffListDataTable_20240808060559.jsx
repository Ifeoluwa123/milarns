     ...
     <div className='data_table   no-scrollbar    overflow-x-auto scrollbar-hidden-x'>
             ...
             <tbody>
                ...
                paginatedData.map((item,i)=>{
                 ...
                 <tr    className='relative z-[10] table_row  hover:bg-[--grey-color] rounded-md hover:shadow-[2px_2px_1px_2px_rgba(0,0,0,1)] '>
                         ...
                         <td className=''>
                          ...
                          <td  >
                              ...
                              {/* <span  onMouseOver={() => handleRowClick(item.code)} className='table_row hidden md:block cursor-pointer '><BiDotsVerticalRounded /></span> */}
                              <span   className=' hidden md:block cursor-pointer '><BiDotsVerticalRounded /></span>
                          
  {/* DESKTOP VIEW */}
  <div className="table_menu_list bg-[var(--grey-color)] hidden md:block absolute  md:right-[2%]   hover:bg-[var(--grey-color)] z-[200]">
