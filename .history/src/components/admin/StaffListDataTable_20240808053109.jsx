...
{selectedUser?.code === item.code && (
      ...
      <div className="bg-[var(--grey-color)]   hover:bg-[var(--grey-color)] absolute  right-[2%] z-[200]">
<div className=" h-full border-2  mt-[-15px] hidden md:block   p-0 z-[50]   rounded-md overflow-hidden absolute  md:right-[2%] md:top-[20%] bg-[var(--grey-color)]  w-fit  shadow-[2px_2px_1px_2px_rgba(0,0,0,1)]">
