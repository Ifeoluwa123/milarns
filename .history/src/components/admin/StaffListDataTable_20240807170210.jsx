...
{selectedUser?.code === item.code && (
  ...
  <tr  className='relative top-[-1px] bg-[var(--grey-color)]   hover:bg-[var(--grey-color)]  '>
   ...
   {/* DESKTOP VIEW */}
   <td colSpan="4"   className="mt-[-15px] hidde md:block   p-0 z-[50]   rounded-md overflow-hidden absolute  md:right-[2%] md:top-[20%] bg-[var(--grey-color)]  w-fit  shadow-[2px_2px_1px_2px_rgba(0,0,0,1)]">
