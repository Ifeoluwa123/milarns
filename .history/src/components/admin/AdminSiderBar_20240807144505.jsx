...
function MobileView({pathname, isSidebarOpen, setIsSideBarOpen}){
  ...
  return(
      <div className={` ${isSidebarOpen? 'left-0':'left-[-100%]'} transition-all duration-[0.3s]   flex justify-between bg-[rgba(0,0,0,0.7)] h-screen md:hidden fixed top-0 w-full z-[200]`}>
          ...
          <div className="border-b-[1px] py-[0.85rem] mx-auto w-full md:pl-[2rem] pl-0">
              <Link to="/admin" className="md:w-[100px] w-full md:block flex justify-center items-center">
                {/* {adminInfo?  <img src={adminInfo.user.avatar } alt="" /> :  <img src={Logo2 } alt="" />}   */}
                <img src={Logo2 } alt="" />
              </Link>
          </div>
          ...
          <div className="text-white border- border-red-900 h-fit absolute top-[5rem] md:top-[7rem] pl-[1.5rem] w-full ">
                 <div className="">
                     ...
                     {/* {adminInfo? <img src={adminInfo?.user.avatar?adminInfo?.user.avatar : userPlaceholder } className='w-full object-cover block' alt="" /> */}
