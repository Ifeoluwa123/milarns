  ...
  return (
    ...
    >
      <ModalContent className='bg-white  rounded-md'>
        {(onClose) => (
          <>
            <ModalHeader className="bg-[linear-gradient(to_bottom,rgb(254,94,85),rgb(254,94,85))] z-[-1] text-white border-none outline-none">
                    <div className=" bg-[url('../assets/images/bg-modal-header.png'),center,cover] h-full w-full flex justify-between items-center  gap-1 ">
                OTP Code
