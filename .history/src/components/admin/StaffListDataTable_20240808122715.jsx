     ...
     <div className="px-[0.8rem] relative sm:px-[3rem] lg:px-[2rem]   flex  flex-col gap-y-[1rem] sm:flex-row sm:items-center sm:justify-between mt-[2rem] pr-[1.8rem] " >
         ...
         <div className="flex  items-center w-full gap-x-[1rem]  sm:gap-x-[1rem]  sm:flex-row">
             <div className="rlative">
               ...
               <TableMenuList  items={[
                  {icon:<CiUser size={15} />, onClick:handleBulkSelection, text: "Activate staffs"},     
                  {icon:<LiaUserAltSlashSolid size={15} />, onClick:handleBulkSelection, text: "Deactivate staffs", type:"", actionType:"deactivate"},      
                  // {icon:<IoCardOutline size={15} />, text: "Activate Cards", type:"", actionType:"deactivate"},      
                  {icon:<IoTrashOutline size={15} />, onClick:()=>handleBulkSelection('Delete', <IoTrashOutline size={15} />), text: "Delete staffs", type:"", actionType:"deactivate"},      
