  ...
  return (
    ...
    >
      <ModalContent className='bg-white  rounded-md'>
        {(onClose) => (
          <>
            <ModalHeader className="bg-[linear-gradient(to_bottom,rgb(254,94,8),rgb(254,94,85)),url('../assets/images/bg-modal-header.png')] text-white border-none flex justify-between items-center  gap-1 outline-none">
                OTP Code
