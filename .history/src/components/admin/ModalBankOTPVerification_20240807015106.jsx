      ...
      <ModalContent className='bg-white  rounded-md'>
        {(onClose) => (
          <>
            ...
            <div className="">
            {
                errorMsg.error && <div className={`${errorMsg.error && 'bg-[#FDEAEA] text-[#FE5E55] mb-[1rem] rounded-[4px] w-fit p-[4px_20px_4px_20px]' }`}>{errMsg.error}</div>
               } 
            {
               errorMsg.success && <div className={`${ errorMsg.success && 'bg-[var(--primary-color)] text-white mb-[1rem] rounded-[4px] w-fit p-[4px_20px_4px_20px]' }`}>{ errMsg.success}</div>
               } 
            </div>
