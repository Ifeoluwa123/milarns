...
<div className="">
  <p className='text-[1rem] mt-[2rem]'>No debit card generated for staff yet. You can request for it. And we shall get back to you within 48 hours.</p>
        ...
        <div className="mt-[2rem]">
            <InnerButton icon={<TfiReload />} text={`${isPending? 'Loading...':'Request Card' }`} width="w-fit"/>
...
<p className='mt-[33px] p-[4px_20px_4px_20px] max-w-[320px] w-full rounded-[4px] bg-[#F3F4F6] text-[#008080]'>Staff credit card has been requested, it will be delivered as soon as possible</p>
